...
<table class="table_add">
	...
	<tr>
		...
		<td>
			<input type="text" name="email" value="{{edit.email}}" class="input" style="width: 70%;" rangelength="[6,32]" email="true" required />
		</td>
	</tr>
	<tr>
		<td class="tright">手机号码:</td>
		<td>
			<input type="text" name="tel" value="{{edit.tel}}" class="input" style="width: 70%;" tel="true" required />
		</td>
	</tr>
	<tr>
